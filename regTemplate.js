var inputTownElement = document.querySelector(".TempInput");
var addBtn = document.querySelector(".TempAddButton");
var resetBtn = document.querySelector(".TempResetBtn");
var displayTownElement = document.querySelector(".TempDisplayTown");
var towns = document.querySelector(".TempTown");
var errorMsg = document.querySelector(".TempErrorMsg");
var successMsgElement = document.querySelector(".TempSuccess");
